...
Button CheckInBtn,BreakOutBtn,BreakInBtn,CheckOutBtn;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        ImgAgain =view.findViewById(R.id.ImgAgain);
            ...
            if(grantResults.length > 0 && grantResults[0] == PackageManager.PERMISSION_GRANTED){
                ...
                if (ActivityCompat.shouldShowRequestPermissionRationale(getActivity(), Manifest.permission.CAMERA)) {
                 ...
                 //   Toast.makeText(c, "Never ask again selected.", Toast.LENGTH_SHORT).show();
                    c.finish();
                    Toast.makeText(c, "اعطاء تصريح للكاميرا مطلوب لاستخدام التطبيق. برجاء اعطاء التصريح من اعدادات التطبيق", Toast.LENGTH_LONG).show();
                }
            }
        }
            ...
            if(grantResults.length > 0 && grantResults[0] == PackageManager.PERMISSION_GRANTED){
              // locationModel.GetLocation(getActivity());
                ...
                if (ActivityCompat.shouldShowRequestPermissionRationale(getActivity(), Manifest.permission.ACCESS_COARSE_LOCATION)) {
                    ...
                    //   Toast.makeText(c, "Never ask again selected.", Toast.LENGTH_SHORT).show();
                    c.finish();
                    Toast.makeText(c, "اعطاء تصريح للوقع مطلوب لاستخدام التطبيق. برجاء اعطاء التصريح من اعدادات التطبيق", Toast.LENGTH_LONG).show();
                }
            }
   ...
   /* public void DisplayLocation(){
    ...
    protected  void SendAttendance(int status){
        ...
        if(bitmap==null){
         ...
         //   Log.d("CurrentUser", ImageToString());
                ...
                public void onResponse(Call<CheckResponse> call, Response<CheckResponse> response) {
                    ...
                    if(response.body()!=null) {
                      ...
                      //  Toast.makeText(c, response.body().message, Toast.LENGTH_SHORT).show();
                        ...
                        ImgAgain.setVisibility(View.GONE);
        ...
        SingleShotLocationProvider.requestSingleUpdate(context,
                new SingleShotLocationProvider.LocationCallback() {
                    ...
                    @Override public void onNewLocationAvailable(SingleShotLocationProvider.GPSCoordinates NewLocation) {
                        Log.d("Location", "my location is " + NewLocation.latitude + "   "+NewLocation.longitude);
                        location =NewLocation;
                        SendAttendance(AttendStatue);
